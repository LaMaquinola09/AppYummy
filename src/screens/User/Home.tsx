        ...
        <View style={styles.suggestedOrders}>
          ...
          <ScrollView horizontal showsHorizontalScrollIndicator={false}>
            <View style={styles.suggestedCardContainer}>
              ...
              <View style={styles.bestSellerCard}>
                ...
                <View style={styles.productDetails}>
                  ...
                  <Text style={styles.productDescription}>
                    Deliciosa pizza con salsa de tomate y queso mozzarella
                  </Text>
              ...
              <View style={styles.bestSellerCard}>
                <Image
                  source={require("../../../assets/sopapasta.jpg")}
                  style={styles.productImage}
                />
                <View style={styles.productDetails}>
                  <Text style={styles.productName}>Pasta Alfredo</Text>
                  <Text style={styles.productDescription}>
                    Pasta con salsa cremosa de queso parmesano y ajo.
                  </Text>
              ...
              <View style={styles.bestSellerCard}>
                ...
                <View style={styles.productDetails}>
                  ...
                  <Text style={styles.productDescription}>
                    Crujiente lechuga con aderezo César y crutones.
                  </Text>
              ...
              <View style={styles.bestSellerCard}>
                ...
                <View style={styles.productDetails}>
                  ...
                  <Text style={styles.productDescription}>
                    Tacos de cerdo marinado con piña y cebolla.
                  </Text>
              ...
              <View style={styles.bestSellerCard}>
                <Image
                  source={require("../../../assets/Pastel.jpg")}
                  style={styles.productImage}
                />
                <View style={styles.productDetails}>
                  <Text style={styles.productName}>Helado de Vainilla</Text>
                  <Text style={styles.productDescription}>
                    Suave helado de vainilla con trocitos de chocolate.
                  </Text>
            ...
            <View style={styles.bestSellerCardContainer}>
              ...
              <View style={styles.bestSellerCard}>
                ...
                <View style={styles.productDetails}>
                  ...
                  <Text style={styles.productDescription}>
                    Taza de café filtrado, fuerte y aromático
                  </Text>
              ...
              <View style={styles.bestSellerCard}>
                <Image
                  source={require("../../../assets/pastelchocolate.jpg")}
                  style={styles.productImage}
                />
                <View style={styles.productDetails}>
              ...
              <View style={styles.bestSellerCard}>
                ...
                <View style={styles.productDetails}>
                  ...
                  <Text style={styles.productDescription}>
                    Camarones frescos salteados en salsa de ajo
                  </Text>
            ...
            <View style={styles.bestSellerCardContainer}>
              ...
              <View style={styles.bestSellerCard}>
                ...
                <View style={styles.productDetails}>
                  ...
                  <Text style={styles.productDescription}>
                    Pasta con salsa cremosa de huevo, queso y panceta
                  </Text>
                  <Text style={styles.productSKU}>SKU: 002</Text>
              ...
              <View style={styles.bestSellerCard}>
                ...
                <View style={styles.productDetails}>
                  <Text style={styles.productName}>Ensalada César</Text>
                  <Text style={styles.productDescription}>
                    Crujiente lechuga con pollo, queso parmesano y aderezo César
                  </Text>
                  <Text style={styles.productSKU}>SKU: 003</Text>
